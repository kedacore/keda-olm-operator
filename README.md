...
spec:
  ...
  metricsServer:
    ...
    # can be set via 'Args' field manually. Non-empty 'policy' field is required
    # for logging. If 'logOutputVolumeClaim' is empty log to stdout otherwise it
    # is a name of user defined PersistentVolumeClaim resourse.
    # auditConfig:
    #   logFormat: "json"
    #   logOutputVolumeClaim: "persistentVolumeClaim"
    #   policy:
    #     rules:
    #     - level: Metadata
