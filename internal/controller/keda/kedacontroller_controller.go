...
func (r *KedaControllerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if instance.GetDeletionTimestamp() != nil {
		if controllerutil.ContainsFinalizer(instance, kedaControllerFinalizer) {
			...
			if err := r.finalizeKedaController(ctx, logger); err != nil {
				return ctrl.Result{}, err
			}
...
func (r *KedaControllerReconciler) installGeneralResources(ctx context.Context, logger logr.Logger, instance *kedav1alpha1.KedaController) error {
	...
	if err := toApply.Apply(ctx); err != nil {
...
func (r *KedaControllerReconciler) installController(ctx context.Context, logger logr.Logger, instance *kedav1alpha1.KedaController) error {
	...
	if err := r.resourcesController.Apply(ctx); err != nil {
...
func (r *KedaControllerReconciler) installMonitoring(ctx context.Context, logger logr.Logger, instance *kedav1alpha1.KedaController) error {
	...
	if err := r.resourcesMonitoring.Apply(ctx); err != nil {
...
func deleteHTTPAddonManifest(ctx context.Context, logger logr.Logger, manifest mf.Manifest, component string) error {
	if manifest.Client == nil && len(manifest.Resources()) == 0 {
		return nil
	}
	if err := manifest.Delete(ctx); err != nil {
...
func (r *KedaControllerReconciler) deleteHTTPAddon(ctx context.Context, logger logr.Logger) error {
	if err := deleteHTTPAddonManifest(ctx, logger, r.resourcesHTTPAddonScaler, "Scaler"); err != nil {
		return err
	}
	if err := deleteHTTPAddonManifest(ctx, logger, r.resourcesHTTPAddonInterceptor, "Interceptor"); err != nil {
		return err
	}
	if err := deleteHTTPAddonManifest(ctx, logger, r.resourcesHTTPAddonOperator, "Operator"); err != nil {
		return err
	}
	return nil
}
...
func (r *KedaControllerReconciler) installHTTPAddon(ctx context.Context, logger logr.Logger, instance *kedav1alpha1.KedaController, status *kedav1alpha1.KedaControllerStatus) error {
	...
	if err := r.resourcesHTTPAddonOperator.Apply(ctx); err != nil {
	...
	if err := r.resourcesHTTPAddonInterceptor.Apply(ctx); err != nil {
	...
	if err := r.resourcesHTTPAddonScaler.Apply(ctx); err != nil {
...
func (r *KedaControllerReconciler) installMetricsServer(ctx context.Context, logger logr.Logger, instance *kedav1alpha1.KedaController) error {
	...
	if err := r.resourcesMetrics.Apply(ctx); err != nil {
...
func (r *KedaControllerReconciler) installAdmissionWebhooks(ctx context.Context, logger logr.Logger, instance *kedav1alpha1.KedaController) error {
	...
	if err := r.resourcesWebhooks.Apply(ctx); err != nil {
